---
name: backlog
description: Backlog.md is a comprehensive project management system built around a CLI tool that manages tasks, documentation, and project metadata in markdown files. Use when you need to create, edit, and track tasks with rich metadata, manage acceptance criteria and definition of done checklists, visualize project boards, integrate with Git branches, and maintain structured documentation and decision records
---
...
1. **Tests pass**: Run test suite and linting
2. **Documentation updated**: Update relevant docs if needed
3. **Code reviewed**: Self-review your changes
4. **No regressions**: Performance, security checks pass
